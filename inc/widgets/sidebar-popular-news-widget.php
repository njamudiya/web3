...
function ideal_blog_sidebar_popular_news() {
	register_widget( 'Ideal_Blog_Sidebar_Popular_Posts' );
}
add_action( 'widgets_init', 'ideal_blog_sidebar_popular_news' );

class Ideal_Blog_Sidebar_Popular_Posts extends WP_Widget{ 
	...
	function __construct() {
		...
		parent::__construct( 'Ideal_Blog_Sidebar_Popular_Posts',esc_html__( 'ST: Sidebar Popular Posts', 'ideal-blog' ), $widget_sidebar_popular, $control_ops );
	}
